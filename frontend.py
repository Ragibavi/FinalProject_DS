...
# --- Sidebar Navigation
page = st.sidebar.selectbox("📂 Navigasi", ["Lihat Data", "Input Data"])

# --- Halaman: Lihat Data
if page == "Lihat Data":
    st.title("Data yang Tersimpan")
    try:
        ...
        if res.status_code == 200:
            ...
            st.warning(f"⚠️ Gagal mengambil data dari API. Status: {res.status_code}")
